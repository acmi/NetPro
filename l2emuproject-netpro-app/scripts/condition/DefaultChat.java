...
/**
 * Tests whether the value of a byte/word/dword is not equal to 11.<BR>
 * <BR>
 * Used to check the type of chat in <TT>ChatMessage</TT>.
 * 
 * @author savormix
 */
public class DefaultChat extends ScriptedFieldValueCondition implements IntegerCondition
{
	@Override
