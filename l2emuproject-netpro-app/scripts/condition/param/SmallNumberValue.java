...
/**
 * Tests whether the value of a byte/word/dword is equal to 21.<BR>
 * <BR>
 * Used to check the type of parameter in <TT>SystemMessage</TT>.
 * 
 * @author savormix
 */
public class SmallNumberValue extends ScriptedIntegerEqualityCondition
{
	/** Constructs this interpreter. */
	public SmallNumberValue()
	{
		super(21);
	}
}
