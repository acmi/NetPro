 ...
 * @author _dev_
 */
public final class ServerListC1 extends ScriptedFieldValueCondition implements IntegerCondition, ServerListTypePublisher
{
	@Override
	public boolean test(long value)
	{
		return LIST_TYPE.get() >= RequestServerList.TYPE_C1;
	}
}
