...
public class PSLogFileHeader
{
	 ...
	 */
	PSLogFileHeader(Path logFile, long logFileSize, int version, int packets, boolean multipart, int partNumber, int servicePort, InetAddress clientIP, InetAddress serverIP,
