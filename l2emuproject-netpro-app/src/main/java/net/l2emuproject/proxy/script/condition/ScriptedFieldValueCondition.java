...
/**
 * Enhances {@link FieldValueCondition} with managed script capabilities.
 * 
 * @author _dev_
 */
public abstract class ScriptedFieldValueCondition extends ScriptedMetaclass implements FieldValueCondition
{
	@Override
