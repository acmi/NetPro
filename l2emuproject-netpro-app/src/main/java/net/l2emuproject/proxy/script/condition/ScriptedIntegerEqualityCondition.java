...
import net.l2emuproject.proxy.network.meta.condition.IntegerEqualityCondition;
import net.l2emuproject.proxy.network.meta.container.MetaclassRegistry;
import net.l2emuproject.proxy.script.ScriptedMetaclass;

/**
 * Enhances {@link IntegerEqualityCondition} with managed script capabilities.
 * 
 * @author _dev_
 */
public abstract class ScriptedIntegerEqualityCondition extends IntegerEqualityCondition implements UnloadableScript
{
	/**
	 ...
	 */
	protected ScriptedIntegerEqualityCondition(long value)
	{
		super(value);
	}
