...
public abstract class ScriptedZeroBasedIntegerIdInterpreter extends ZeroBasedIntegerIdTranslator implements UnloadableScript
{
	 ...
	 */
	protected ScriptedZeroBasedIntegerIdInterpreter(InterpreterMetadata metadata, Object... interpretations)
	{
		super(metadata, interpretations);
	}
	 ...
	 * @param interpretations known ID interpretations
	 */
	protected ScriptedZeroBasedIntegerIdInterpreter(Object... interpretations)
	{
		super(interpretations);
	}
