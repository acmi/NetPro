 ...
 */
package net.l2emuproject.proxy.script.modifier;
...
/**
 * Enhances {@link FieldValueModifier} with managed script capabilities.
 * 
 * @author _dev_
 */
public abstract class ScriptedFieldValueModifier extends ScriptedMetaclass implements FieldValueModifier
{
	@Override
