 ...
 * @author savormix
 */
public final class PledgeCrestInfoCache extends EntityInfoCache<PledgeCrestInfo>
{
	PledgeCrestInfoCache()
	{
		// singleton
	}
	 ...
	 */
	public static final PledgeCrestInfoCache getInstance()
	{
	...
	{
		static final PledgeCrestInfoCache INSTANCE = new PledgeCrestInfoCache();
	}
}
