 ...
 * @author _dev_
 */
public class RawStreamVisitor implements HistoricalLogPacketVisitor, IOConstants
{
	 ...
	 */
	public RawStreamVisitor(EndpointType streamType, boolean timestamps, boolean encipher)
	{
	...
	public void onPacket(ReceivedPacket packet) throws Exception
	{
		...
		// BEWARE: this is not AuthD-friendly!
