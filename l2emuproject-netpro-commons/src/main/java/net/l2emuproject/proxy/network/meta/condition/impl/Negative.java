...
/**
 * Tests whether the value of a byte/word/dword/qword is negative (lower than zero).
 * 
 * @author savormix
 */
public final class Negative implements IntegerCondition, DecimalCondition
{
	@Override
