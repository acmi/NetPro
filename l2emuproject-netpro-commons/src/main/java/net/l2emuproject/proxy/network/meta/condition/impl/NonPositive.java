...
/**
 * Tests whether the value of a byte/word/dword/qword is non positive (lower than or equal to zero).
 * 
 * @author savormix
 */
public final class NonPositive implements IntegerCondition, DecimalCondition
{
	@Override
