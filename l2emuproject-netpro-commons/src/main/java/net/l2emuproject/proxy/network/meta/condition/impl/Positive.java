...
/**
 * Tests whether the value of a byte/word/dword/qword is positive (greater than zero).
 * 
 * @author savormix
 */
public final class Positive implements IntegerCondition, DecimalCondition
{
	@Override
