...
/**
 * A class that represents a dynamically sized byte array field.
 * 
 * @author _dev_
 */
public final class DynamicSizeByteArrayFieldElement extends AbstractByteArrayFieldElement
{
	/**
	 ...
	 */
	public DynamicSizeByteArrayFieldElement(String id, String alias, boolean optional, Set<String> fieldAliases,
	...
	{
		final int length = ((Number)args[0]).intValue();
		return buf.readB(length);
	}
}
