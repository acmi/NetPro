...
/**
 * A class that represents a double precision floating point field.
 * 
 * @author _dev_
 */
public final class DoublePrecisionFPElement extends AbstractDecimalFieldElement
{
	/**
	 ...
	 */
	public DoublePrecisionFPElement(String id, String alias, boolean optional, Set<String> fieldAliases,
