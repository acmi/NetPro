 ...
 * @author _dev_
 */
public final class Int16FieldElement extends AbstractIntegerFieldElement
{
	/**
	 ...
	 */
	public Int16FieldElement(String id, String alias, boolean optional, Set<String> fieldAliases, String valueModifier,
