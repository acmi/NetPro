 ...
 * @author _dev_
 */
public final class Int32FieldElement extends AbstractIntegerFieldElement
{
	/**
	 ...
	 */
	public Int32FieldElement(String id, String alias, boolean optional, Set<String> fieldAliases, String valueModifier,
