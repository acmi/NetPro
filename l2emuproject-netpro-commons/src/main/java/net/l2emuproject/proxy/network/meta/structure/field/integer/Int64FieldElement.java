...
/**
 * A class that represents a signed 8 bit integer field.
 * 
 * @author _dev_
 */
public final class Int64FieldElement extends AbstractIntegerFieldElement
{
	/**
	 ...
	 */
	public Int64FieldElement(String id, String alias, boolean optional, Set<String> fieldAliases, String valueModifier,
