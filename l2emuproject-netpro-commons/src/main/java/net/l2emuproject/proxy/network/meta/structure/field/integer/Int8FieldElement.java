 ...
 * @author _dev_
 */
public final class Int8FieldElement extends AbstractIntegerFieldElement
{
	/**
	 ...
	 */
	public Int8FieldElement(String id, String alias, boolean optional, Set<String> fieldAliases, String valueModifier,
