 ...
 * @author _dev_
 */
public final class UInt8FieldElement extends AbstractIntegerFieldElement
{
	/**
	 ...
	 */
	public UInt8FieldElement(String id, String alias, boolean optional, Set<String> fieldAliases, String valueModifier,
