...
/**
 * A class that represents a nul-terminated 8 bit string field.
 * 
 * @author _dev_
 */
public final class NulTerminated8BitStringElement extends AbstractStringFieldElement
{
	/**
	 ...
	 */
	public NulTerminated8BitStringElement(String id, String alias, boolean optional, Set<String> fieldAliases, String valueModifier, String valueInterpreter)
	{
