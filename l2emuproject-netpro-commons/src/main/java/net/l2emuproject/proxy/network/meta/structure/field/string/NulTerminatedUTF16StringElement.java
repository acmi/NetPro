...
/**
 * A class that represents a nul-terminated UTF-16 string field.
 * 
 * @author _dev_
 */
public final class NulTerminatedUTF16StringElement extends AbstractStringFieldElement
{
	/**
	 ...
	 */
	public NulTerminatedUTF16StringElement(String id, String alias, boolean optional, Set<String> fieldAliases,
