...
/**
 * A class that represents a sized UTF-16 string field.
 * 
 * @author _dev_
 */
public final class SizedUTF16StringElement extends AbstractStringFieldElement
{
	/**
	 ...
	 */
	public SizedUTF16StringElement(String id, String alias, boolean optional, Set<String> fieldAliases,
